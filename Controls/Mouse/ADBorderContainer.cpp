...
ADBorderContainer::ADBorderContainer(QWidget *parent) : QWidget(parent)
{
    padding = 8;
    moveEnable = true;
    resizeEnable = true;
...
void ADBorderContainer::doWindowStateChange(QEvent *event)
{
    // 非最大化才能移动和拖动大小
...
void ADBorderContainer::doResizeEvent(QEvent *event)
{
...
bool ADBorderContainer::eventFilter(QObject *watched, QEvent *event)
{
    if (watched == this)
    {
...
void ADBorderContainer::setMoveEnable(bool moveEnable)
{
    this->moveEnable = moveEnable;
}

void ADBorderContainer::setResizeEnable(bool resizeEnable)
{
    this->resizeEnable = resizeEnable;
}

void ADBorderContainer::setTitleBar(QWidget *titleBar)
{
